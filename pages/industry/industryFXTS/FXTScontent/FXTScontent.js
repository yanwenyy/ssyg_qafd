// pages/industry/industryFXTS/FXTScontent/FXTScontent.js
const app = getApp();
Page({
  ...
  onShareAppMessage: function () {
    return {
      ...
      path: '/pages/share/fxts/fxts?from=fxts&&id='+this.data.id
    }
  },
  ...
  lookDZlist: function () {
    wx.navigateTo({
      url: '../../industryZCGJ/industryDZ/industryDZ?type=3&id=' + this.data.id,
    })
  },
